...
import { Addrizhi2Component } from './addrizhi2/addrizhi2.component';

@Component({
  selector: 'app-rizhi2',
  templateUrl: './rizhi2.page.html',
  styleUrls: ['./rizhi2.page.scss'],
})
export class Rizhi2Page implements OnInit {
    ...
    var objstate = [
      {
        ...
        icon: 'create',
        handler: () => {
          //this.nav.navigateRoot(['/stuxiangqing/' + item.ID]);//页面跳转
          this.updateRizhi(item);
        }
      },
      {
        text: '删除',
