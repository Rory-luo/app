...
/*----------------------------------------后台Api地址----------------------------------------*/
export const APP_SERVE_URL = 'http://fsy86.xw3q.net/';
//export const APP_SERVE_URL = 'http://localhost:62853/'; //跳转Url  测试专用
...
export const REQUEST_TIMEOUT = 200000;//请求超时时间,单位为毫秒
